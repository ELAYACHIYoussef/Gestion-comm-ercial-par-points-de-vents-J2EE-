...
public class CartAction extends ActionSupport implements SessionAware {
	...
	@Autowired
	private ICartService cartService =SingletonService.getCartServiceImpl();
    ...
    public String ajouter() {
        ...
        if (article == null) {
            // Le produit n'existe pas, vous pouvez gérer l'erreur ici
            return ERROR;
        }
        ...
        cartService.addToCart(login, codePdt);
        setMessage("added");
        return SUCCESS;
    }
