    ...
    <div class="card card0" align="center" style="padding: 25px ;">
       <s:form action="savePass" method="post">   
		 	...
		 	<h3 class="mb-5 text-center heading"> New Password</h3>
				...
				<div class="m-2">
					<s:password class="form-control" name="pass" placeholder="Enter your new Password "  theme="simple"/>
				</div>
				<div class="m-2">
					<s:password class="form-control" name="confirmPass" placeholder="Confirm Password "  theme="simple"/>
				</div>
