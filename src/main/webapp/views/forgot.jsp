                     ...
                     <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                           <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Recover your account</p>
                              <s:form class="mx-1 mx-md-4" name="upadateForm" action="updateUser" method="post">
                                 ...
                                 <div class="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                       <s:password class="form-control" name="pass" id="form3Example1c" theme="simple" />
                                 ...
                                 <div class="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                       <s:password class="form-control" name="confirmPass" id="form3Example1c" theme="simple" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <s:select id="form3Example3c" class="form-control"
                                       ...
                                       name="securityQuestion" value="In what city did you meet your spouse/significant other?" theme="simple"/>
                                 ...
                                 <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                    <s:submit value="Continue" class="btn btn-primary btn-lg"/>
                                    <p class="text-danger"><s:property value="message" /></p>
                                    <p class="text-danger"><s:property value="message1" /></p>
                                 </div>
                              </s:form>
                              <!--  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
